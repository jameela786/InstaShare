...
class Home extends Component {
  ...
  getUserProfileApi = async () => {
    ...
    try {
      ...
      console.log('user profile errror:', error)
      this.setState({apiStatus: apiStatusConstants.failure})
    }
  }
  ...
  renderHomeVideos = () => {
    ...
    switch (apiStatus) {
      ...
      case apiStatusPostsConstants.failure:
        return this.renderApiFailedUserStories()
    ...
    <>
      <div className="failureApi_container">
        <div className="failure_icon">
          <img
            alt="failure view"
            src="https://res.cloudinary.com/dd3phabkh/image/upload/v1734346061/Group_7522_l2xzn0.png"
          />
  ...
  renderApiFailedUserStories = () => (
    <>
      <div className="failureApi_container">
        <div className="failure_icon">
          <img
            className="userstoryfailed_img"
            alt="failure view"
            src="https://res.cloudinary.com/dd3phabkh/image/upload/v1734346061/Group_7522_l2xzn0.png"
          />
        </div>
        ...
        <button
          type="button"
          onClick={this.OnRetryApiUserStories}
          className="retry_btn"
        >
          Try again
        </button>
